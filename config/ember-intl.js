...
module.exports = function(/* environment */) {
  return {
     ...
     * @default "null"
     */
//      fallbackLocale: "en", //-- may be better for production but hides the missing translations that we usually want to be highlighted for dev version
	fallbackLocale: null,// for our intl service to report missing translations we disable the fallback BUT our intl service will use the 'en' default in production if a key is missing for another locale
...
//     }
    requiresTranslation(key, locale) {
      return false;//no warning for missing translations on build
    }
